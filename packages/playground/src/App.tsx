  ...
  const handleSubmit = async () => {
    try {
      ...
      console.log('res', res)
        ...
        // Updated section: Adjust the file extensions for .ts and .json
