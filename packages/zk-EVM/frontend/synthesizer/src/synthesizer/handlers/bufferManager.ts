import { SUBCIRCUIT_BUFFER_MAPPING } from 'src/interface/qapCompiler/importedConstants.ts';
...
import { NUMBER_OF_PREV_BLOCK_HASHES } from '@tokamak-zk-evm/qap-compiler';
