...
import { ARITH_EXP_BATCH_SIZE, JUBJUB_EXP_BATCH_SIZE, POSEIDON_INPUTS } from "@tokamak-zk-evm/qap-compiler"
import { poseidon_raw, poseidon_raw2xCompress } from "@tokamak-zk-evm/tokamak-l2js"
import { DEFAULT_SOURCE_BIT_SIZE} from "src/synthesizer/params/constants.ts"
...
export class ArithmeticOperations {
  ...
  static poseidonN2xCompress(in_vals: bigint[]): bigint {
    return poseidon_raw2xCompress(in_vals)
  }
