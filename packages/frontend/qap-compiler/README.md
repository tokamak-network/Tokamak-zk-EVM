...
- Modular components for Merkle tree (Poseidon) proof verification
- Modular components for EdDSA (jubjub + Poseidon) signature verification
### Testing subcircuits (Outdated)
