...
import type { Common, ParamsDict, StateManagerInterface, VerkleAccessWitnessInterface } from '@ethereumjs/common/dist/esm/index.js';
...
export declare const DELEGATION_7702_FLAG: Uint8Array;
export {};
