...
function BLS12_381_ToG1Point(input, mcl, verifyOrder = true) {
    ...
    const p_x = (0, index_js_1.bytesToUnprefixedHex)(input.subarray(16, constants_js_1.BLS_G1_POINT_BYTE_LENGTH / 2));
    const p_y = (0, index_js_1.bytesToUnprefixedHex)(input.subarray(80, constants_js_1.BLS_G1_POINT_BYTE_LENGTH));
    const G1 = new mcl.G1();
...
function BLS12_381_FromG1Point(input) {
    ...
    const xBytes = (0, index_js_1.setLengthLeft)((0, index_js_1.unprefixedHexToBytes)(decoded[1]), 64);
    const yBytes = (0, index_js_1.setLengthLeft)((0, index_js_1.unprefixedHexToBytes)(decoded[2]), 64);
...
function BLS12_381_FromG2Point(input) {
    ...
    const decoded = decodeStr.match(/"?[0-9a-f]+"?/g); // match above pattern.
    const xBytes1 = (0, index_js_1.setLengthLeft)((0, index_js_1.unprefixedHexToBytes)(decoded[1]), 64);
    const xBytes2 = (0, index_js_1.setLengthLeft)((0, index_js_1.unprefixedHexToBytes)(decoded[2]), 64);
    const yBytes1 = (0, index_js_1.setLengthLeft)((0, index_js_1.unprefixedHexToBytes)(decoded[3]), 64);
    const yBytes2 = (0, index_js_1.setLengthLeft)((0, index_js_1.unprefixedHexToBytes)(decoded[4]), 64);
...
function BLS12_381_ToFrPoint(input, mcl) {
    const mclHex = mcl.fromHexStr((0, index_js_1.bytesToUnprefixedHex)(input));
    const Fr = new mcl.Fr();
...
function BLS12_381_ToFpPoint(fpCoordinate, mcl) {
    ...
    const fp = new mcl.Fp();
    fp.setBigEndianMod(mcl.fromHexStr((0, index_js_1.bytesToUnprefixedHex)(fpCoordinate)));
    return fp;
}
...
function BLS12_381_ToFp2Point(fpXCoordinate, fpYCoordinate, mcl) {
    ...
    fp_x.setStr((0, index_js_1.bytesToUnprefixedHex)(fpXCoordinate.subarray(16)), 16);
    fp_y.setStr((0, index_js_1.bytesToUnprefixedHex)(fpYCoordinate.subarray(16)), 16);
    fp2.set_a(fp_x);
    fp2.set_b(fp_y);
    return fp2;
}
