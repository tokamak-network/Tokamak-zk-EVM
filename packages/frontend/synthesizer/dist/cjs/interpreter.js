...
const setup_js_1 = require("./eof/setup.js");
const verify_js_1 = require("./eof/verify.js");
const exceptions_js_1 = require("./exceptions.js");
const memory_js_1 = require("./memory.js");
const message_js_1 = require("./message.js");
const index_js_3 = require("./opcodes/index.js");
const stack_js_1 = require("./stack.js");
const memoryPt_js_1 = require("./tokamak/pointers/memoryPt.js");
const stackPt_js_1 = require("./tokamak/pointers/stackPt.js");
const index_js_4 = require("./tokamak/utils/index.js");
...
class Interpreter {
    ...
    constructor(evm, stateManager, blockchain, env, gasLeft, journal, performanceLogs, synthesizer, profilerOpts) {
        ...
        this._runState = {
            ...
            memoryPt: new memoryPt_js_1.MemoryPt(),
            memoryWordCount: index_js_2.BIGINT_0,
            highestMemCost: index_js_2.BIGINT_0,
            stack: new stack_js_1.Stack(),
            stackPt: new stackPt_js_1.StackPt(),
    ...
    async run(code, opts = {}) {
        if (!this.common.isActivatedEIP(3540) || code[0] !== constants_js_1.FORMAT) {
            ...
            if (code[2] !== constants_js_1.VERSION) {
            ...
            const eofMode = isTxCreate ? container_js_1.EOFContainerMode.TxInitmode : container_js_1.EOFContainerMode.Default;
            try {
                (0, setup_js_1.setupEOF)(this._runState, eofMode);
            }
            catch (e) {
                return {
                    runState: this._runState,
                    exceptionError: new exceptions_js_1.EvmError(exceptions_js_1.ERROR.INVALID_EOF_FORMAT), // TODO: verify if all gas should be consumed
                };
            }
            if (isTxCreate) {
                // Tx tries to deploy container
                try {
                    (0, container_js_1.validateEOF)(this._runState.code, this._evm, verify_js_1.ContainerSectionType.InitCode, container_js_1.EOFContainerMode.TxInitmode);
                }
                catch (e) {
    ...
    async _runStepHook(dynamicFee, gasLeft) {
        ...
        if (this._evm.DEBUG) {
            ...
            hexStack = eventObj.stack.map((item) => {
                return (0, index_js_2.bigIntToHex)(BigInt(item));
            });
            /*eslint-disable */
            ...
            const stringMemoryPt = (0, index_js_4.mapToStr)(this._runState.memoryPt._storePt);
            const name = eventObj.opcode.name;
            const opTrace = {
                pc: eventObj.pc,
                op: name,
                gas: (0, index_js_2.bigIntToHex)(eventObj.gasLeft),
                gasCost: (0, index_js_2.bigIntToHex)(dynamicFee),
                stack: hexStack,
                depth: eventObj.depth,
            };
            // console.log(`"memory": ${JSON.stringify(eventObj.memory)}\n`)
            console.log(`"memory": ${stringMemory.slice(0, 256)}\n`);
            console.log(`"stackPt": ${JSON.stringify(this._runState.stackPt.getStack(), index_js_4.arrToStr, 2)}\n`);
        ...
        for (let i = 0; i < code.length; i++) {
            ...
            if (opcode <= 0x7f) {
                if (opcode >= 0x60) {
                    ...
                    const push = (0, index_js_2.bytesToBigInt)(code.slice(i + 1, i + opcode - 0x5e));
                    pushes[i + 1] = push;
                    i += extraSteps;
                }
                else if (opcode === 0x5b) {
    ...
    useGas(amount, context) {
        ...
        if (this._runState.gasLeft < index_js_2.BIGINT_0) {
            this._runState.gasLeft = index_js_2.BIGINT_0;
            (0, index_js_3.trap)(exceptions_js_1.ERROR.OUT_OF_GAS);
        }
    }
    /**
    ...
    subRefund(amount, context) {
        ...
        this._runState.gasRefund -= amount;
        if (this._runState.gasRefund < index_js_2.BIGINT_0) {
            this._runState.gasRefund = index_js_2.BIGINT_0;
            (0, index_js_3.trap)(exceptions_js_1.ERROR.REFUND_EXHAUSTED);
        }
    }
    /**
    ...
    finish(returnData) {
        ...
        (0, index_js_3.trap)(exceptions_js_1.ERROR.STOP);
    }
    /**
    ...
    revert(returnData) {
        this._result.returnValue = returnData;
        (0, index_js_3.trap)(exceptions_js_1.ERROR.REVERT);
    }
    /**
     ...
     */
    getCaller() {
        return (0, index_js_2.bytesToBigInt)(this._env.caller.bytes);
    }
    /**
     ...
     */
    getTxOrigin() {
        return (0, index_js_2.bytesToBigInt)(this._env.origin.bytes);
    }
    /**
    ...
    getBlockCoinbase() {
        let coinbase;
        if (this.common.consensusAlgorithm() === index_js_1.ConsensusAlgorithm.Clique) {
            coinbase = this._evm['_optsCached'].cliqueSigner(this._env.block.header);
        }
        else {
            coinbase = this._env.block.header.coinbase;
        }
        return (0, index_js_2.bytesToBigInt)(coinbase.toBytes());
    }
    /**
     ...
     */
    getBlockPrevRandao() {
        return (0, index_js_2.bytesToBigInt)(this._env.block.header.prevRandao);
    }
    /**
    ...
    async _baseCall(msg) {
        ...
        if (!results.execResult.exceptionError) {
            ...
            this._env.contract = account;
            this._runState.gasRefund = results.execResult.gasRefund ?? index_js_2.BIGINT_0;
        }
    ...
    async create(gasLimit, value, codeToRun, salt, eofCallData) {
        ...
        // EIP-2681 check
        if (this._env.contract.nonce >= index_js_2.MAX_UINT64) {
            return index_js_2.BIGINT_0;
        }
        this._env.contract.nonce += index_js_2.BIGINT_1;
        ...
        if (!results.execResult.exceptionError ||
            ...
            if (results.createdAddress) {
                ...
                return (0, index_js_2.bytesToBigInt)(results.createdAddress.bytes);
            }
        }
    ...
    async _selfDestruct(toAddress) {
        ...
        if (!this._result.selfdestruct.has((0, index_js_2.bytesToHex)(this._env.address.bytes))) {
            this.refundGas(this.common.param('selfdestructRefundGas'));
        }
        this._result.selfdestruct.add((0, index_js_2.bytesToHex)(this._env.address.bytes));
        const toSelf = (0, index_js_2.equalsBytes)(toAddress.bytes, this._env.address.bytes);
    ...
    log(data, numberOfTopics, topics) {
        if (numberOfTopics < 0 || numberOfTopics > 4) {
            (0, index_js_3.trap)(exceptions_js_1.ERROR.OUT_OF_RANGE);
        }
        if (topics.length !== numberOfTopics) {
            (0, index_js_3.trap)(exceptions_js_1.ERROR.INTERNAL_ERROR);
        }
    ...
    _getReturnCode(results, isEOFCreate = false) {
        if (this._runState.env.eof === undefined || isEOFCreate) {
            if (results.execResult.exceptionError) {
                ...
                return index_js_2.BIGINT_1;
            }
        }
        else {
            // EOF mode, call was either EXTCALL / EXTDELEGATECALL / EXTSTATICCALL
            if (results.execResult.exceptionError !== undefined) {
                if (results.execResult.exceptionError.error === exceptions_js_1.ERROR.REVERT) {
                    // Revert
                    return index_js_2.BIGINT_1;
                }
                else {
                    // Failure
                    return index_js_2.BIGINT_2;
                }
            }
            return index_js_2.BIGINT_0;
        }
