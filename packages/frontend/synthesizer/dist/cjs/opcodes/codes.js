...
const hardforkOpcodes = [
    {
        hardfork: index_js_1.Hardfork.Homestead,
        opcodes: {
            0xf4: asyncAndDynamicGasOp('DELEGATECALL'), // EIP-7
        },
    },
    {
        hardfork: index_js_1.Hardfork.TangerineWhistle,
        opcodes: {
            0x54: asyncAndDynamicGasOp('SLOAD'),
            0xf1: asyncAndDynamicGasOp('CALL'),
            0xf2: asyncAndDynamicGasOp('CALLCODE'),
            0x3b: asyncAndDynamicGasOp('EXTCODESIZE'),
            0x3c: asyncAndDynamicGasOp('EXTCODECOPY'),
            0xf4: asyncAndDynamicGasOp('DELEGATECALL'),
            0xff: asyncAndDynamicGasOp('SELFDESTRUCT'),
            0x31: asyncAndDynamicGasOp('BALANCE'),
        },
    },
    {
        hardfork: index_js_1.Hardfork.Byzantium,
        opcodes: {
            0xfd: dynamicGasOp('REVERT'),
            0xfa: asyncAndDynamicGasOp('STATICCALL'),
            0x3d: asyncOp('RETURNDATASIZE'),
            0x3e: asyncAndDynamicGasOp('RETURNDATACOPY'), // EIP-211
        },
    },
    {
        hardfork: index_js_1.Hardfork.Constantinople,
        opcodes: {
            0x1b: defaultOp('SHL'),
            0x1c: defaultOp('SHR'),
            0x1d: defaultOp('SAR'),
            0x3f: asyncAndDynamicGasOp('EXTCODEHASH'),
            0xf5: asyncAndDynamicGasOp('CREATE2'), // EIP-1014
        },
    },
    {
        hardfork: index_js_1.Hardfork.Istanbul,
        opcodes: {
            0x46: defaultOp('CHAINID'),
            0x47: defaultOp('SELFBALANCE'), // EIP-1884
        },
    },
    {
        hardfork: index_js_1.Hardfork.Paris,
        opcodes: {
