...
function getEIP7702DelegatedAddress(code) {
    if ((0, index_js_1.equalsBytes)(code.slice(0, 3), types_js_1.DELEGATION_7702_FLAG)) {
        return new index_js_1.Address(code.slice(3, 24));
    }
}
...
exports.handlers = new Map([
    ...
    [
        0x00,
        function () {
            (0, util_js_2.trap)(exceptions_js_1.ERROR.STOP);
        },
    ],
    // 0x01: ADD
    [
        ...
        function (runState) {
            ...
            const r = (0, util_js_2.mod)(a + b, index_js_1.TWO_POW256);
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('ADD', [a, b], r, runState);
        },
    ],
    // 0x02: MUL
    [
        ...
        function (runState) {
            ...
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('MUL', [a, b], r, runState);
        },
    ],
    // 0x03: SUB
    [
        ...
        function (runState) {
            ...
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('SUB', [a, b], r, runState);
        },
    ],
    // 0x04: DIV
    [
        ...
        function (runState) {
            const [a, b] = runState.stack.popN(2);
            let r;
            if (b === index_js_1.BIGINT_0) {
                r = index_js_1.BIGINT_0;
            }
            else {
                r = (0, util_js_2.mod)(a / b, index_js_1.TWO_POW256);
            }
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('DIV', [a, b], r, runState);
        },
    ],
    // 0x05: SDIV
    [
        ...
        function (runState) {
            ...
            if (b === index_js_1.BIGINT_0) {
                ...
                r = (0, util_js_2.toTwos)((0, util_js_2.fromTwos)(a) / (0, util_js_2.fromTwos)(b));
            }
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('SDIV', [a, b], r, runState);
        },
    ],
    // 0x06: MOD
    [
        ...
        function (runState) {
            ...
            if (b === index_js_1.BIGINT_0) {
                ...
                r = (0, util_js_2.mod)(a, b);
            }
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('MOD', [a, b], r, runState);
        },
    ],
    // 0x07: SMOD
    [
        ...
        function (runState) {
            ...
            if (b === index_js_1.BIGINT_0) {
                ...
                r = (0, util_js_2.fromTwos)(a) % (0, util_js_2.fromTwos)(b);
            }
            runState.stack.push((0, util_js_2.toTwos)(r));
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('SMOD', [a, b], 
    ...
    [
        ...
        function (runState) {
            ...
            let r;
            if (c === index_js_1.BIGINT_0) {
                r = index_js_1.BIGINT_0;
            }
            else {
                r = (0, util_js_2.mod)(a + b, c);
            }
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('ADDMOD', [a, b, c], r, runState);
        },
    ],
    // 0x09: MULMOD
    [
        ...
        function (runState) {
            ...
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('MULMOD', [a, b, c], r, runState);
        },
    ],
    // 0x0a: EXP
    [
        ...
        function (runState) {
            ...
            if (base === index_js_1.BIGINT_2) {
                switch (exponent) {
                    case index_js_1.BIGINT_96:
                        runState.stack.push(index_js_1.BIGINT_2EXP96);
                        return;
                    case index_js_1.BIGINT_160:
                        runState.stack.push(index_js_1.BIGINT_2EXP160);
                        return;
                    case index_js_1.BIGINT_224:
                        runState.stack.push(index_js_1.BIGINT_2EXP224);
                        return;
                }
            }
            if (exponent === index_js_1.BIGINT_0) {
                runState.stack.push(index_js_1.BIGINT_1);
                return;
            }
            if (base === index_js_1.BIGINT_0) {
                runState.stack.push(base);
                return;
            }
            const r = (0, util_js_2.exponentiation)(base, exponent);
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('EXP', [base, exponent], r, runState);
        },
    ],
    // 0x0b: SIGNEXTEND
    [
        ...
        function (runState) {
            ...
            let val = _val;
            if (k < index_js_1.BIGINT_31) {
                const signBit = k * index_js_1.BIGINT_8 + index_js_1.BIGINT_7;
                const mask = (index_js_1.BIGINT_1 << signBit) - index_js_1.BIGINT_1;
                if ((_val >> signBit) & index_js_1.BIGINT_1) {
            ...
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('SIGNEXTEND', [k, _val], val, runState);
        },
    ],
    // 0x10 range - bit ops
    // 0x10: LT
    [
        ...
        function (runState) {
            const [a, b] = runState.stack.popN(2);
            const r = a < b ? index_js_1.BIGINT_1 : index_js_1.BIGINT_0;
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('LT', [a, b], r, runState);
        },
    ],
    // 0x11: GT
    [
        ...
        function (runState) {
            ...
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('GT', [a, b], r, runState);
        },
    ],
    // 0x12: SLT
    [
        ...
        function (runState) {
            const [a, b] = runState.stack.popN(2);
            const r = (0, util_js_2.fromTwos)(a) < (0, util_js_2.fromTwos)(b) ? index_js_1.BIGINT_1 : index_js_1.BIGINT_0;
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('SLT', [a, b], r, runState);
        },
    ],
    // 0x13: SGT
    [
        ...
        function (runState) {
            ...
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('SGT', [a, b], r, runState);
        },
    ],
    // 0x14: EQ
    [
        ...
        function (runState) {
            ...
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('EQ', [a, b], r, runState);
        },
    ],
    // 0x15: ISZERO
    [
        ...
        function (runState) {
            ...
            const r = a === index_js_1.BIGINT_0 ? index_js_1.BIGINT_1 : index_js_1.BIGINT_0;
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('ISZERO', [a], r, runState);
        },
    ],
    // 0x16: AND
    [
        ...
        function (runState) {
            ...
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('AND', [a, b], r, runState);
        },
    ],
    // 0x17: OR
    [
        ...
        function (runState) {
            ...
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('OR', [a, b], r, runState);
        },
    ],
    // 0x18: XOR
    [
        ...
        function (runState) {
            ...
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('XOR', [a, b], r, runState);
        },
    ],
    // 0x19: NOT
    [
        ...
        function (runState) {
            ...
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('NOT', [a], r, runState);
        },
    ],
    // 0x1a: BYTE
    [
        ...
        function (runState) {
            ...
            if (pos > index_js_1.BIGINT_32) {
                runState.stack.push(index_js_1.BIGINT_0);
                return;
            }
            const r = (word >> ((index_js_1.BIGINT_31 - pos) * index_js_1.BIGINT_8)) & index_js_1.BIGINT_255;
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('BYTE', [pos, word], r, runState);
        },
    ],
    // 0x1b: SHL
    [
        ...
        function (runState) {
            const [a, b] = runState.stack.popN(2);
            if (a > index_js_1.BIGINT_256) {
                runState.stack.push(index_js_1.BIGINT_0);
                return;
            }
            const r = (b << a) & index_js_1.MAX_INTEGER_BIGINT;
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('SHL', [a, b], r, runState);
        },
    ],
    // 0x1c: SHR
    [
        ...
        function (runState) {
            ...
            if (a > 256) {
                runState.stack.push(index_js_1.BIGINT_0);
                // For Synthesizer //
                (0, synthesizer_js_1.synthesizerArith)('SHR', [a, b], index_js_1.BIGINT_0, runState);
                return;
            }
            const r = b >> a;
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('SHR', [a, b], r, runState);
        },
    ],
    // 0x1d: SAR
    [
        ...
        function (runState) {
            ...
            if (a > 256) {
                if (isSigned) {
                    r = index_js_1.MAX_INTEGER_BIGINT;
                }
                else {
                    r = index_js_1.BIGINT_0;
                }
            ...
            const c = b >> a;
            if (isSigned) {
                const shiftedOutWidth = index_js_1.BIGINT_255 - a;
                const mask = (index_js_1.MAX_INTEGER_BIGINT >> shiftedOutWidth) << shiftedOutWidth;
                r = c | mask;
            }
            else {
                r = c;
            ...
            runState.stack.push(r);
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerArith)('SAR', [a, b], r, runState);
        },
    ],
    // 0x20 range - crypto
    // 0x20: KECCAK256
    [
        ...
        function (runState, common) {
            ...
            if (length !== index_js_1.BIGINT_0) {
                data = runState.memory.read(Number(offset), Number(length));
            }
            const r = BigInt((0, index_js_1.bytesToHex)((common.customCrypto.keccak256 ?? keccak_js_1.keccak256)(data)));
            runState.stack.push(r);
            // For synthesizer //
            ...
            const chunkDataPts = [];
            let dataRecovered = index_js_1.BIGINT_0;
            ...
            for (let i = 0; i < nChunks; i++) {
                ...
                if (dataAliasInfos.length > 0) {
                    ...
                    chunkDataPts[i] = runState.synthesizer.loadAuxin(index_js_1.BIGINT_0);
                }
    ...
    [
        ...
        async function (runState) {
            const address = (0, index_js_1.bytesToBigInt)(runState.interpreter.getAddress().bytes);
    ...
    [
        ...
        async function (runState) {
            ...
            const address = (0, util_js_2.createAddressFromStackBigInt)(addressBigInt);
    ...
    [
        ...
        async function (runState) {
            ...
            let r = (0, index_js_1.bytesToBigInt)(loaded);
            if (loaded.length < 32) {
                r = r << (index_js_1.BIGINT_8 * BigInt(32 - loaded.length));
            }
            runState.stack.push(r);
            // For synthesizer //
            await (0, synthesizer_js_1.synthesizerEnvInf)('CALLDATALOAD', runState, undefined, pos);
    ...
    [
        ...
        function (runState) {
            ...
            if (dataLength !== index_js_1.BIGINT_0) {
                const data = (0, util_js_2.getDataSlice)(runState.interpreter.getCallData(), dataOffset, dataLength);
            ...
            if (dataLength !== index_js_1.BIGINT_0) {
                ...
                if (calldataMemoryPts.length > 0) {
                    ...
                    memoryPtsToCopy = (0, index_js_2.copyMemoryRegion)(runState, dataOffset, dataLength, calldataMemoryPts, memOffset);
                }
                else {
                    ...
                    const entryToCopy = {
                        ...
                        dataPt: runState.synthesizer.loadEnvInf(runState.env.address.toString(), 'Calldata', (0, index_js_1.bytesToBigInt)(data), dataOffsetNum, Number(dataLength)),
                    };
    ...
    [
        ...
        function (runState) {
            ...
            if (dataLength !== index_js_1.BIGINT_0) {
                const data = (0, util_js_2.getDataSlice)(runState.interpreter.getCode(), codeOffset, dataLength);
                const memOffsetNum = Number(memOffset);
    ...
    [
        ...
        async function (runState, common) {
            ...
            if ((0, util_js_1.isEOF)(code)) {
                // In legacy code, the target code is treated as to be "EOFBYTES" code
                runState.stack.push(BigInt(util_js_1.EOFBYTES.length));
                // For Synthesizer //
    ...
    [
        ...
        async function (runState, common) {
            ...
            if (dataLength !== index_js_1.BIGINT_0) {
                ...
                if ((0, util_js_1.isEOF)(code)) {
                    // In legacy code, the target code is treated as to be "EOFBYTES" code
                    code = util_js_1.EOFBYTES;
                }
                else if (common.isActivatedEIP(7702)) {
                    code = await eip7702CodeCheck(runState, code);
                }
                const data = (0, util_js_2.getDataSlice)(code, codeOffset, dataLength);
                const memOffsetNum = Number(memOffset);
                const lengthNum = Number(dataLength);
                runState.memory.write(memOffsetNum, lengthNum, data);
            }
            ...
            if (dataLength !== index_js_1.BIGINT_0) {
                const dataPt = await (0, synthesizer_js_1.prepareEXTCodePt)(runState, addressBigInt, codeOffset, dataLength);
                runState.memoryPt.write(Number(memOffset), Number(dataLength), dataPt);
            }
            const _outData = runState.memoryPt.viewMemory(Number(memOffset), Number(dataLength));
            const outData = runState.memory.read(Number(memOffset), Number(dataLength));
    ...
    [
        ...
        async function (runState, common) {
            ...
            if ((0, util_js_1.isEOF)(code)) {
                ...
                runState.stack.push((0, index_js_1.bytesToBigInt)(util_js_1.EOFHASH));
                // For Synthesizer //
                ...
                if (possibleDelegatedAddress !== undefined) {
                    ...
                    runState.stack.push(BigInt((0, index_js_1.bytesToHex)(account.codeHash)));
                    // For Synthesizer //
                    await (0, synthesizer_js_1.synthesizerEnvInf)('EXTCODEHASH', runState, addressBigInt);
                    return;
                }
                else {
                    runState.stack.push((0, index_js_1.bytesToBigInt)((0, keccak_js_1.keccak256)(code)));
                    // For Synthesizer //
                    await (0, synthesizer_js_1.synthesizerEnvInf)('EXTCODEHASH', runState, addressBigInt);
                    return;
                }
    ...
    [
        ...
        function (runState) {
            ...
            if (dataLength !== index_js_1.BIGINT_0) {
                const data = (0, util_js_2.getDataSlice)(runState.interpreter.getReturnData(), returnDataOffset, dataLength);
                const memOffsetNum = Number(memOffset);
                const lengthNum = Number(dataLength);
                runState.memory.write(memOffsetNum, lengthNum, data);
            }
            ...
            if (dataLength !== index_js_1.BIGINT_0) {
                const copiedMemoryPts = (0, index_js_2.copyMemoryRegion)(runState, returnDataOffset, dataLength, runState.returnMemoryPts, memOffset);
        ...
        async function (runState, common) {
            ...
            if (common.isActivatedEIP(7709)) {
                if (number >= runState.interpreter.getBlockNumber()) {
                    runState.stack.push(index_js_1.BIGINT_0);
                    // For Synthesizer //
                    (0, synthesizer_js_1.synthesizerBlkInf)('BLOCKHASH', runState, number);
                    return;
                }
                ...
                if (diff > index_js_1.BIGINT_256 || diff <= index_js_1.BIGINT_0) {
                    runState.stack.push(index_js_1.BIGINT_0);
                    // For Synthesizer //
                    (0, synthesizer_js_1.synthesizerBlkInf)('BLOCKHASH', runState, number);
                    return;
                }
                const historyAddress = new index_js_1.Address((0, index_js_1.bigIntToAddressBytes)(common.param('historyStorageAddress')));
                const historyServeWindow = common.param('historyServeWindow');
                const key = (0, index_js_1.setLengthLeft)((0, index_js_1.bigIntToBytes)(number % historyServeWindow), 32);
                if (common.isActivatedEIP(6800)) {
                    const { treeIndex, subIndex } = (0, index_js_1.getVerkleTreeIndicesForStorageSlot)(number);
                ...
                runState.stack.push((0, index_js_1.bytesToBigInt)(storage));
            }
            else {
                const diff = runState.interpreter.getBlockNumber() - number;
                ...
                runState.stack.push((0, index_js_1.bytesToBigInt)(block.hash()));
            }
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerBlkInf)('BLOCKHASH', runState, number);
        },
    ...
    [
        ...
        function (runState) {
            ...
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerBlkInf)('COINBASE', runState);
        },
    ],
    // 0x42: TIMESTAMP
    [
        ...
        function (runState) {
            ...
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerBlkInf)('TIMESTAMP', runState);
        },
    ],
    // 0x43: NUMBER
    [
        ...
        function (runState) {
            ...
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerBlkInf)('NUMBER', runState);
        },
    ],
    ...
    [
        ...
        function (runState, common) {
            ...
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerBlkInf)('DIFFICULTY', runState);
        },
    ],
    // 0x45: GASLIMIT
    [
        ...
        function (runState) {
            ...
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerBlkInf)('GASLIMIT', runState);
        },
    ],
    // 0x46: CHAINID
    [
        ...
        function (runState) {
            ...
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerBlkInf)('CHAINID', runState);
        },
    ],
    // 0x47: SELFBALANCE
    [
        ...
        function (runState) {
            ...
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerBlkInf)('SELFBALANCE', runState);
        },
    ],
    // 0x48: BASEFEE
    [
        ...
        function (runState) {
            ...
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerBlkInf)('BASEFEE', runState);
        },
    ],
    // 0x49: BLOBHASH
    [
        ...
        function (runState) {
            ...
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerBlkInf)('BLOBHASH', runState, index);
        },
    ],
    // 0x4a: BLOBBASEFEE
    [
        ...
        function (runState) {
            ...
            // For Synthesizer //
            (0, synthesizer_js_1.synthesizerBlkInf)('BLOBBASEFEE', runState);
        },
    ],
    ...
    [
        ...
        function (runState) {
            ...
            runState.stack.push((0, index_js_1.bytesToBigInt)(word));
            // For Synthesizer //
            const loadSize = 32;
    ...
    [
        ...
        function (runState) {
            ...
            const buf = (0, index_js_1.setLengthLeft)((0, index_js_1.bigIntToBytes)(word), 32);
            const offsetNum = Number(offset);
    ...
    [
        ...
        function (runState) {
            ...
            const buf = (0, index_js_1.bigIntToBytes)(byte & index_js_1.BIGINT_255);
            const offsetNum = Number(offset);
            ...
            const [offsetPt, newDataPt] = runState.stackPt.popN(2);
            const _offsetNum = Number(offsetPt.value);
            if (_offsetNum !== offsetNum || newDataPt.value !== (0, index_js_1.bytesToBigInt)(buf)) {
    ...
    [
        ...
        async function (runState) {
            ...
            const keyBuf = (0, index_js_1.setLengthLeft)((0, index_js_1.bigIntToBytes)(key), 32);
            const value = await runState.interpreter.storageLoad(keyBuf);
            const valueBigInt = value.length ? (0, index_js_1.bytesToBigInt)(value) : index_js_1.BIGINT_0;
    ...
    [
        ...
        async function (runState) {
            ...
            let value;
            if (val === index_js_1.BIGINT_0) {
                value = Uint8Array.from([]);
            }
            else {
                value = (0, index_js_1.bigIntToBytes)(val);
            }
    ...
    [
        ...
        function (runState) {
            ...
            if (dest > runState.interpreter.getCodeSize()) {
                (0, util_js_2.trap)(exceptions_js_1.ERROR.INVALID_JUMP + ' at ' + (0, util_js_2.describeLocation)(runState));
            }
            const destNum = Number(dest);
            if (!(0, util_js_2.jumpIsValid)(runState, destNum)) {
                (0, util_js_2.trap)(exceptions_js_1.ERROR.INVALID_JUMP + ' at ' + (0, util_js_2.describeLocation)(runState));
            }
    ...
    [
        0x59,
        function (runState) {
            runState.stack.push(runState.memoryWordCount * index_js_1.BIGINT_32);
        },
    ],
    // 0x5a: GAS
    [
    ...
    [
        ...
        function (runState) {
            ...
            const valueBN = value.length ? (0, index_js_1.bytesToBigInt)(value) : index_js_1.BIGINT_0;
            ...
            if (dataPt === undefined) {
                dataPt = runState.synthesizer.loadAuxin(index_js_1.BIGINT_0);
            }
    ...
    [
        ...
        function (runState) {
            ...
            if (runState.interpreter.isStatic()) {
                (0, util_js_2.trap)(exceptions_js_1.ERROR.STATIC_STATE_CHANGE);
            }
            const [key, val] = runState.stack.popN(2);
            const keyBuf = (0, index_js_1.setLengthLeft)((0, index_js_1.bigIntToBytes)(key), 32);
            // NOTE: this should be the shortest representation
    ...
    [
        ...
        function (runState) {
            ...
            const copiedMemoryPts = (0, index_js_2.copyMemoryRegion)(runState, src, length, undefined, dst);
            for (const entry of copiedMemoryPts) {
                // the lower index, the older data
                runState.memoryPt.write(entry.memOffset, entry.containerSize, entry.dataPt);
            }
    ...
    [
        ...
        function (runState) {
            runState.stack.push(index_js_1.BIGINT_0);
            // For Synthesizer //
            const dataPt = runState.synthesizer.loadPUSH(runState.env.address.toString(), runState.programCounterPrev, index_js_1.BIGINT_0, 1);
            runState.stackPt.push(dataPt);
            if (runState.stackPt.peek(1)[0].value !== runState.stack.peek(1)[0]) {
    ...
    [
        ...
        function (runState, common) {
            ...
            if (runState.programCounter + numToPush > runState.code.length &&
                ...
                (0, util_js_2.trap)(exceptions_js_1.ERROR.OUT_OF_RANGE);
            }
            ...
            if (!runState.shouldDoJumpAnalysis) {
                ...
                const loaded = (0, index_js_1.bytesToBigInt)(runState.code.subarray(runState.programCounter, runState.programCounter + numToPush));
                runState.programCounter += numToPush;
    ...
    [
        ...
        function (runState) {
            ...
            const topicsBuf = topics.map(function (a) {
                return (0, index_js_1.setLengthLeft)((0, index_js_1.bigIntToBytes)(a), 32);
            });
            let mem = new Uint8Array(0);
            if (memLength !== index_js_1.BIGINT_0) {
    ...
    [
        ...
        function (runState, _common) {
            if (runState.env.eof === undefined) {
                ...
                (0, util_js_2.trap)(exceptions_js_1.ERROR.INVALID_OPCODE);
            }
            const pos = runState.stack.pop();
    ...
    [
        ...
        function (runState, _common) {
            ...
            const toLoad = Number((0, index_js_1.bytesToBigInt)(runState.code.subarray(runState.programCounter, runState.programCounter + 2)));
            const data = (0, index_js_1.bytesToBigInt)(runState.env.eof.container.body.dataSection.subarray(toLoad, toLoad + 32));
    ...
    [
        ...
        function (runState, _common) {
            ...
            if (size !== index_js_1.BIGINT_0) {
                const data = (0, util_js_2.getDataSlice)(runState.env.eof.container.body.dataSection, offset, size);
                const memOffsetNum = Number(memOffset);
    ...
    [
        ...
        function (runState, _common) {
            ...
            const sectionTarget = (0, index_js_1.bytesToInt)(runState.code.slice(runState.programCounter, runState.programCounter + 2));
            ...
            if (1024 < stackItems + typeSection?.inputs - typeSection?.maxStackHeight) {
                (0, util_js_2.trap)(errors_js_1.EOFError.StackOverflow);
            }
            if (runState.env.eof.eofRunState.returnStack.length >= 1024) {
                (0, util_js_2.trap)(errors_js_1.EOFError.ReturnStackOverflow);
            }
    ...
    [
        ...
        function (runState, _common) {
            ...
            if (newPc === undefined) {
                ...
                (0, util_js_2.trap)(errors_js_1.EOFError.RetfNoReturn);
            }
    ...
    [
        ...
        function (runState, _common) {
            ...
            const toDup = Number((0, index_js_1.bytesToBigInt)(runState.code.subarray(runState.programCounter, runState.programCounter + 1))) + 1;
    ...
    [
        ...
        function (runState, _common) {
            ...
            const toSwap = Number((0, index_js_1.bytesToBigInt)(runState.code.subarray(runState.programCounter, runState.programCounter + 1))) + 1;
    ...
    [
        ...
        function (runState, _common) {
            ...
            const toExchange = Number((0, index_js_1.bytesToBigInt)(runState.code.subarray(runState.programCounter, runState.programCounter + 1)));
    ...
    [
        ...
        async function (runState, _common) {
            if (runState.env.eof === undefined) {
                ...
                let data = new Uint8Array(0);
                if (inputSize !== index_js_1.BIGINT_0) {
                    data = runState.memory.read(Number(inputOffset), Number(inputSize), true);
                }
                runState.programCounter++; // Jump over the immediate byte
                const ret = await runState.interpreter.eofcreate(gasLimit, value, containerCode, (0, index_js_1.setLengthLeft)((0, index_js_1.bigIntToBytes)(salt), 32), data);
    ...
    [
        ...
        async function (runState, _common) {
            if (runState.env.eof === undefined) {
                ...
                const deployContainer = new container_js_1.EOFContainer(containerCode, container_js_1.EOFContainerMode.Initmode);
                // Pop stack values
                const [auxDataOffset, auxDataSize] = runState.stack.popN(2);
                let auxData = new Uint8Array(0);
                if (auxDataSize !== index_js_1.BIGINT_0) {
                ...
                if (actualSectionSize < originalDataSize) {
                    (0, util_js_2.trap)(errors_js_1.EOFError.InvalidReturnContractDataSize);
                }
                if (actualSectionSize > 0xffff) {
                    // Data section size is now larger than the max data section size
                    // Temp: trap OOG?
                    (0, util_js_2.trap)(exceptions_js_1.ERROR.OUT_OF_GAS);
                }
                const newSize = (0, index_js_1.setLengthLeft)((0, index_js_1.bigIntToBytes)(BigInt(actualSectionSize)), 2);
                ...
                const returnContainer = (0, index_js_1.concatBytes)(containerCode, auxData);
    ...
    [
        ...
        async function (runState, common) {
            ...
            if (common.isActivatedEIP(3860) &&
                ...
                (0, util_js_2.trap)(exceptions_js_1.ERROR.INITCODE_SIZE_VIOLATION);
            }
            const gasLimit = runState.messageGasLimit;
            runState.messageGasLimit = undefined;
            let data = new Uint8Array(0);
    ...
    [
        ...
        async function (runState, common) {
            ...
            const ret = await runState.interpreter.create2(gasLimit, value, data, (0, index_js_1.setLengthLeft)((0, index_js_1.bigIntToBytes)(salt), 32));
            runState.stack.push(ret);
        },
    ],
    // 0xf1: CALL
    [
        ...
        async function (runState, common) {
            ...
            const toAddress = (0, util_js_2.createAddressFromStackBigInt)(toAddr);
            let data = new Uint8Array(0);
            if (inLength !== index_js_1.BIGINT_0) {
                data = runState.memory.read(Number(inOffset), Number(inLength), true);
            }
            let gasLimit = runState.messageGasLimit;
            if (value !== index_js_1.BIGINT_0) {
            ...
            const calldataMemoryPts = (0, index_js_2.copyMemoryRegion)(runState, inOffset, inLength);
            // for debugging
            const simCalldataMemoryPt = (0, index_js_2.simulateMemoryPt)(calldataMemoryPts);
            const _data = simCalldataMemoryPt.viewMemory(0, Number(inLength));
            if (!(0, index_js_1.equalsBytes)(_data, data)) {
            ...
            (0, util_js_2.writeCallOutput)(runState, outOffset, outLength);
            runState.stack.push(ret);
        },
    ],
    // 0xf2: CALLCODE
    ...
    [
        ...
        async function (runState, _common) {
            if (runState.env.eof === undefined) {
                ...
                const gasLimit = runState.messageGasLimit;
                runState.messageGasLimit = undefined;
                if (gasLimit === -index_js_1.BIGINT_1) {
    ...
    [
        0xfa,
        async function (runState) {
            const value = index_js_1.BIGINT_0;
            const [_currentGasLimit, toAddr, inOffset, inLength, outOffset, outLength] = runState.stack.popN(6);
            const toAddress = (0, util_js_2.createAddressFromStackBigInt)(toAddr);
            const gasLimit = runState.messageGasLimit;
            runState.messageGasLimit = undefined;
    ...
    [
        ...
        function (runState) {
            ...
            const returnMemoryPts = (0, index_js_2.copyMemoryRegion)(runState, offset, length);
    ...
    [
        ...
        async function (runState) {
            ...
            const selfdestructToAddress = (0, util_js_2.createAddressFromStackBigInt)(selfdestructToAddressBigInt);
