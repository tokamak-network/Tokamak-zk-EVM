...
exports.MemoryPt = exports.copyMemoryRegion = exports.simulateMemoryPt = void 0;
...
const simulateMemoryPt = (memoryPts) => {
...
exports.simulateMemoryPt = simulateMemoryPt;
const copyMemoryRegion = (runState, srcOffset, length, fromMemoryPts, dstOffset) => {
    ...
    if (fromMemoryPts === undefined) {
        ...
        const simFromMemoryPt = (0, exports.simulateMemoryPt)(fromMemoryPts);
    ...
    if (toMemoryPts.length > 0) {
        const simToMemoryPt = (0, exports.simulateMemoryPt)(toMemoryPts);
...
exports.copyMemoryRegion = copyMemoryRegion;
/*eslint-disable */
...
class MemoryPt {
    ...
    viewMemory(offset, length) {
        ...
        const simMem = new memory_js_1.Memory();
        for (const memoryPtEntry of memoryPts) {
            ...
            const buf = (0, index_js_1.setLengthLeft)((0, index_js_1.bigIntToBytes)(memoryPtEntry.dataPt.value), containerSize);
