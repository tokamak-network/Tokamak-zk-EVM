...
exports.SynthesizerInstructionValidator = exports.SynthesizerValidator = void 0;
...
class SynthesizerValidator {
    ...
    static validateInputCount(name, actual, expected) {
        if (actual !== expected) {
            throw new errors_js_1.InvalidInputCountError(name, expected, actual);
        }
    }
    /**
     * 서브서킷 이름이 유효한지 검증합니다.
    ...
    static validateSubcircuitName(name, validNames) {
        if (!validNames.includes(name)) {
            throw new errors_js_1.UndefinedSubcircuitError(name);
        }
    }
    /**
...
exports.SynthesizerValidator = SynthesizerValidator;
class SynthesizerInstructionValidator {
    ...
    validateKeccakData(offset, length, mutDataPt) {
        ...
        if ((0, index_js_1.bytesToBigInt)(data) !== mutDataPt.value) {
            throw new Error('Synthesizer: KECCAK256: Data loaded to be hashed mismatch');
        }
    }
}
exports.SynthesizerInstructionValidator = SynthesizerInstructionValidator;
