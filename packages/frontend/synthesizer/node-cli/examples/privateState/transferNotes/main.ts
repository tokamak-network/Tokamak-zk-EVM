...
import { createCircuitGenerator } from '../../../../core/src/app.ts';
...
const main = async () => {
  ...
  if (!configPath) {
    throw new Error('Config file path required. Usage: tsx examples/privateState/transferNotes/main.ts <config.json>');
  }
