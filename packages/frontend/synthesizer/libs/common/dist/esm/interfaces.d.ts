 ...
 * Experimental (do not implement)
 */
export declare enum VerkleAccessedStateType {
    BasicData = "basicData",
    CodeHash = "codeHash",
    Code = "code",
    Storage = "storage"
...
export type VerkleAccessedState = {
    type: Exclude<VerkleAccessedStateType, VerkleAccessedStateType.Code | VerkleAccessedStateType.Storage>;
} | {
    type: VerkleAccessedStateType.Code;
    codeOffset: number;
} | {
    type: VerkleAccessedStateType.Storage;
    slot: bigint;
};
