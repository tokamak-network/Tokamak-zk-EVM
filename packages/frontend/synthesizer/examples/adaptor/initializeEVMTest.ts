...
const main = async () => {
  ...
  const {
    ...
    placementInstance: placementInstance1,
  } = await adapter1.parseTransaction({
  ...
  const calldata2 =
    '0xa9059cbb0000000000000000000000000ce8f6c9d4ad12e56e54018313761487d2d1fee900000000000000000000000000000000000000000000006c6b935b8bbd400000';
  ...
  const {
    ...
    placementInstance: placementInstance2,
  } = await adapter2.parseTransaction({
