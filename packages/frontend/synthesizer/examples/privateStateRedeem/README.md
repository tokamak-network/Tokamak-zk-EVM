...
This example replays `PrivateStateController.redeemNotes1`, `redeemNotes2`, `redeemNotes3`, and `redeemNotes4` against the local `private-state` DApp deployment on anvil.
