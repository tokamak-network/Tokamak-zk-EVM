...
This example replays `PrivateStateController.redeemNotes3`, `redeemNotes4`, `redeemNotes6`, and `redeemNotes8` against the local `private-state` DApp deployment on anvil.
