...
//       const r =
//         (word.value >> ((BigInt(31) - pos.value) * BigInt(8))) & BigInt(255);
...
//           const mask =
//             ((TWO_POW256 - BigInt(1)) >> shiftedOutWidth) << shiftedOutWidth;
//           r = c | mask;
//         } else {
//           r = c;
//         }
...
//             chunkDataPts[i] =
//               runState.synthesizer.placeMemoryToStack(dataAliasInfos);
//           } else {
//             chunkDataPts[i] = runState.synthesizer.loadAuxin(BIGINT_0);
//           }
//           dataRecovered +=
//             chunkDataPts[i].value << BigInt((nChunks - i - 1) * 32 * 8);
//         }
...
//           );
//         } else {
//           const data = runState.interpreter
//             .getCallData()
//             .subarray(
...
//     0x3e,
//     async function (runState) {
//       const [memOffset, returnDataOffset, dataLength] =
...
//       const returnData = runState.memory.read(
//         Number(offset.value),
//         Number(length.value),
//       );
