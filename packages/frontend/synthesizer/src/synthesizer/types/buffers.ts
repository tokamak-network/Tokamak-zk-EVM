...
VARIABLE_DESCRIPTION_INCOMPLETE.TREE_INDEX.extDest = `Storage write tree index`;
VARIABLE_DESCRIPTION_INCOMPLETE.TREE_INDEX.sourceBitSize = 255;

VARIABLE_DESCRIPTION_INCOMPLETE.STORAGE_WRITE.extDest = `Storage write (restricted to 255-bit word)`;
VARIABLE_DESCRIPTION_INCOMPLETE.STORAGE_WRITE.sourceBitSize = 255;
