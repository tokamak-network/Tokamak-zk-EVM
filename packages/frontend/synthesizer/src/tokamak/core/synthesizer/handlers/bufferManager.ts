import { NUMBER_OF_PREV_BLOCK_HASHES } from 'src/tokamak/interface/qapCompiler/importedConstants.ts';
...
import { BUFFER_LIST } from 'src/tokamak/interface/qapCompiler/configuredTypes.ts';
