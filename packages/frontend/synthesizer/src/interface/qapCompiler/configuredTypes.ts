...
export const SUBCIRCUIT_ALU_MAPPING: Record<ArithmeticOperator, [SubcircuitNames, bigint | undefined]> = {
  ...
  Poseidon2xCompress: ['Poseidon', 2n],
  Poseidon3xCompress: ['Poseidon', 4n],
  Poseidon4xCompress: ['Poseidon', 8n],
  Poseidon5xCompress: ['Poseidon', 16n],
  Poseidon6xCompress: ['Poseidon', 32n],
