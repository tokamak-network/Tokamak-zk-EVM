...
import type { ResolvedSubcircuitLibrary } from "../qapCompiler/types.ts"
...
export type SynthesizerSimulationOpts = {
  ...
  storageConfig: TokamakL2StateManagerRPCOpts['storageConfig'],
...
export async function createSynthesizerOptsForSimulationFromRPC(
    ...
    const stateManagerOpts: TokamakL2StateManagerRPCOpts = {
