...
const SPEC_JOBS: readonly SpecJob[] = [
  {
    jsonPath: "src/artifacts/specs/sigma-verify.v1.json",
    generatedPath: "src/artifacts/specs/sigma-verify.v1.generated.ts",
    constName: "SIGMA_VERIFY_V1_SPEC",
  },
  {
    jsonPath: "src/artifacts/specs/verifier-preprocess.v1.json",
    generatedPath: "src/artifacts/specs/verifier-preprocess.v1.generated.ts",
    constName: "VERIFIER_PREPROCESS_V1_SPEC",
  },
  {
    jsonPath: "src/artifacts/specs/verifier-proof.v1.json",
    generatedPath: "src/artifacts/specs/verifier-proof.v1.generated.ts",
  ...
  },
  {
    ...
    generatedPath: "src/artifacts/specs/prover-crs.v1.generated.ts",
