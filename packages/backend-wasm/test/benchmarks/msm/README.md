...
| length | sequential ms/op | msmAffine ms/op | msmAffineRaw ms/op | best | affine raw speedup |
| ---: | ---: | ---: | ---: | :--- | ---: |
| 4 | 1.735 | 2.997 | 1.898 | sequential | 0.91x |
| 8 | 3.538 | 3.323 | 2.977 | msmAffineRaw | 1.19x |
| 16 | 6.843 | 4.076 | 3.912 | msmAffineRaw | 1.75x |
| 32 | 13.661 | 6.134 | 6.051 | msmAffineRaw | 2.26x |
| 64 | 27.265 | 10.131 | 9.911 | msmAffineRaw | 2.75x |
| 128 | 55.151 | 16.664 | 16.736 | msmAffine | 3.30x |
| 256 | 109.872 | 27.841 | 27.870 | msmAffine | 3.94x |
| 512 | 218.491 | 48.181 | 47.189 | msmAffineRaw | 4.63x |
| 1024 | 458.793 | 83.520 | 87.474 | msmAffine | 5.24x |
| 2048 | 878.733 | 143.592 | 151.845 | msmAffine | 5.79x |
| 4096 | 1779.343 | 262.013 | 260.508 | msmAffineRaw | 6.83x |
| 8192 | 3547.007 | 465.636 | 464.609 | msmAffineRaw | 7.63x |
| 16384 | 7085.858 | 865.400 | 854.219 | msmAffineRaw | 8.30x |
| 32768 | 14212.916 | 1594.495 | 1589.499 | msmAffineRaw | 8.94x |
| 65536 | 28335.231 | 2945.946 | 2913.222 | msmAffineRaw | 9.73x |
...
- `msmAffine` and `msmAffineRaw` were close across most lengths.
- The rejected global projective comparison is preserved in the
  [rejected candidate summary](../../../docs/optimization/rejected/rejected-candidate-summary.md)
  rather than retained in executable benchmark code.
