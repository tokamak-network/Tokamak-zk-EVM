...
async function main(): Promise<void> {
  ...
  try {
    ...
    const verifierBinaryInput = await readVerifierBinaryInput(runtimeDir, proverOutput.proofArtifact);
    await timed("load verifier runtime input with generated proof", () =>
