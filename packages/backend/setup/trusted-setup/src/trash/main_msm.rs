...
fn main() {
    ...
    let mut msm_results1 = vec![G1Projective::zero(); 4];
    msm::msm(
    ...
    println!("MSM result1 = {:?}", G1Projective::eq(&msm_results2[0], &(msm_results1[0] + msm_results1[1] + msm_results1[2] + msm_results1[3])));
    println!("MSM result2 = {:?}", G1Projective::eq(&(points[0].to_projective() * scalars[0]), &(msm_results1[0])));
