...
import {IVerifierV2} from "./interface/IVerifierV2.sol";
    ...
    function verify(
        ...
        assembly {
            ...
            function prepareLHSA() {
                ...
                // [V]_1 - V_{x,y}[G]_1
                g1pointSubIntoDest(
                    PROOF_POLY_V_X_SLOT_PART1, BUFFER_AGGREGATED_POLY_X_SLOT_PART1, BUFFER_AGGREGATED_POLY_X_SLOT_PART1
                )

                // κ1([V]_1 - V_{x,y}[G]_1)
                g1pointMulIntoDest(
                    BUFFER_AGGREGATED_POLY_X_SLOT_PART1,
                    mload(CHALLENGE_KAPPA_1_SLOT),
                    BUFFER_AGGREGATED_POLY_X_SLOT_PART1
                )
            ...
            function prepareLHSC() {
                ...
                // R_{x,y}[G]_1
                g1pointMulIntoDest(
                    INTERMERDIARY_POLY_G_X_SLOT_PART1,
                    mulmod(kappa1_pow2_kappa0_chi_1, r1, R_MOD),
                    BUFFER_AGGREGATED_POLY_X_SLOT_PART1
                )
                ...
                // -R'_{x,y}[F]_1
                g1pointMulIntoDest(
                    INTERMERDIARY_POLY_F_X_SLOT_PART1,
                    mulmod(kappa1_pow2_kappa0_chi_1, r2, R_MOD),
                    BUFFER_AGGREGATED_POLY_X_SLOT_PART1
                )
                g1pointSubAssign(AGG_LHS_C_X_SLOT_PART1, BUFFER_AGGREGATED_POLY_X_SLOT_PART1)

                // Add κ1^2 * κ0^2 * K_0(χ) * (R_{x,y}[G]_1 - R''_{x,y}[F]_1)
                let kappa1_pow2_kappa0_pow2_k0 :=
                    mulmod(mulmod(kappa1_pow2, mulmod(kappa0, kappa0, R_MOD), R_MOD), k0, R_MOD)

                // R_{x,y}[G]_1
                g1pointMulIntoDest(
                    INTERMERDIARY_POLY_G_X_SLOT_PART1,
                    mulmod(kappa1_pow2_kappa0_pow2_k0, r1, R_MOD),
                    BUFFER_AGGREGATED_POLY_X_SLOT_PART1
                )
                g1pointAddIntoDest(AGG_LHS_C_X_SLOT_PART1, BUFFER_AGGREGATED_POLY_X_SLOT_PART1, AGG_LHS_C_X_SLOT_PART1)
                ...
                g1pointMulIntoDest(
                    INTERMERDIARY_POLY_F_X_SLOT_PART1,
                    mulmod(kappa1_pow2_kappa0_pow2_k0, r3, R_MOD),
                    BUFFER_AGGREGATED_POLY_X_SLOT_PART1
                )
                g1pointSubAssign(AGG_LHS_C_X_SLOT_PART1, BUFFER_AGGREGATED_POLY_X_SLOT_PART1)
                ...
                g1pointMulIntoDest(
                    PROOF_POLY_QCX_X_SLOT_PART1, mulmod(kappa1_pow2, t_ml, R_MOD), BUFFER_AGGREGATED_POLY_X_SLOT_PART1
                )
                g1pointSubAssign(AGG_LHS_C_X_SLOT_PART1, BUFFER_AGGREGATED_POLY_X_SLOT_PART1)

                // Subtract κ1^2 * t_{s_{max}}(ζ) * [Q_{C,Y}]_1
                g1pointMulIntoDest(
                    PROOF_POLY_QCY_X_SLOT_PART1, mulmod(kappa1_pow2, t_smax, R_MOD), BUFFER_AGGREGATED_POLY_X_SLOT_PART1
                )
                g1pointSubAssign(AGG_LHS_C_X_SLOT_PART1, BUFFER_AGGREGATED_POLY_X_SLOT_PART1)
                ...
                g1pointMulIntoDest(
                    VK_IDENTITY_X_PART1, mulmod(kappa1_pow3, r1, R_MOD), BUFFER_AGGREGATED_POLY_X_SLOT_PART1
                )
                g1pointSubAssign(AGG_LHS_C_X_SLOT_PART1, BUFFER_AGGREGATED_POLY_X_SLOT_PART1)
                ...
                g1pointMulIntoDest(
                    VK_IDENTITY_X_PART1, mulmod(kappa2_pow2, r3, R_MOD), BUFFER_AGGREGATED_POLY_X_SLOT_PART1
                )
                g1pointSubAssign(AGG_LHS_C_X_SLOT_PART1, BUFFER_AGGREGATED_POLY_X_SLOT_PART1)
            }
