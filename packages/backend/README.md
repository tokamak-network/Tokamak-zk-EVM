...
The source of that library depends on the build profile:
...
Each metadata file records the exact bundled subcircuit-library version used for that release build.
