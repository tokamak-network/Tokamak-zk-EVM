...
component main{public [storage_keys_L2MPT, storage_values]} = TokamakStorageMerkleProof(3);

// Tree depth N=3 gives us 64 leaves, which can support:
// - 64 users with 1 storage slots each, OR
// - 32 users with 2 storage slots each, OR
// - 21 users with 3 storage slots each OR
// - 16 users with 4 storage slots each OR
// - 12 users with 5 storage slots each etc...